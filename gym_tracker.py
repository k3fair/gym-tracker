...
st.markdown("<h1 style='text-align: center;'>🏋️‍♂️ Gym Tracker</h1>", unsafe_allow_html=True)
...
tab1, tab2, tab3 = st.tabs(["📋 Workout Log", "📈 Progress Graph", "📅 Calendar View"])
...
with tab3:
    st.subheader("📅 Workout Calendar View")
    if not df.empty:
